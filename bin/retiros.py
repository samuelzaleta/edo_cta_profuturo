...
with define_extraction(phase, area, postgres_pool, postgres_pool) as (postgres, _):
    ...
    with register_time(postgres_pool, phase, term_id, user, area):
        #truncate_table(postgres, 'TTHECHOS_RETIRO_TEST', term=term_id)
        ...
        WHERE (PS.FTC_FOLIO, PS.FTN_NUM_REEXP) IN (
                            SELECT PSMAX.FTC_FOLIO,MAX(PSMAX.FTN_NUM_REEXP)FROM BENEFICIOS.TTCRXGRAL_PAGO_SUBCTA PSMAX
                                ...
                                ON PSMAX.FTC_FOLIO = LS.FTC_FOLIO
        ...
        SELECT FCN_CUENTA, FTC_TMC_DESC_ITGY,
        ...
        FROM (
            SELECT FCN_CUENTA, FTN_TIPO_AHORRO,  FTC_TMC_DESC_ITGY,
            FTF_SALDO_DIA
        ...
        GROUP BY FCN_CUENTA, FTC_TMC_DESC_ITGY
        """
        ...
        _write_spark_dataframe(df, configure_postgres_spark, '"HECHOS"."TTHECHOS_RETIRO_SALDOS_INICIALES"')
