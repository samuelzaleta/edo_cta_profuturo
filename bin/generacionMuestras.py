    ...
    with register_time(postgres_pool, phase=phase, area=area, usuario=user, term=term_id):
        ...
        read_table_insert_temp_view(
            ...
            WITH SaldoIni as (
                ...
                GROUP BY I."FCN_CUENTA", C."FTC_CONCEPTO", F."FCN_ID_FORMATO_ESTADO_CUENTA", PR."FTC_PERIODO", C."FCN_GENERACION"
                )
                SELECT
                "FCN_CUENTA" as "FCN_NUMERO_CUENTA",
                "PERIODO",
                "FTN_ID_FORMATO",
                "FTC_CONCEPTO" as "FTC_CONCEPTO_NEGOCIO",
                ...
                "FTC_CONCEPTO" AS  "FTC_SECCION",
                "FTC_CONCEPTO" AS "FTC_TIPO_AHORRO",
                now() AS "FTD_FECHAHORA_ALTA",
                '0' AS "FTC_USUARIO_ALTA"
                FROM dataset
            """,
