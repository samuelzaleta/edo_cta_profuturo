...
with define_extraction(phase, area, postgres_pool, postgres_oci_pool) as (postgres, postgres_oci):
    ...
    with register_time(postgres_pool, phase, term_id, user, area):
        ...
        def insertar_tablas():
            ...
            extract_dataset_spark(configure_postgres_spark, configure_postgres_oci_spark,
                                  """ SELECT * FROM "MAESTROS"."TCGESPRO_MOVIMIENTO_PROFUTURO" """,
    ...
    :user AS "FTC_USUARIO_ALTA"
    FROM "MAESTROS"."TTGESPRO_CONFIGURACION_FORMATO_ESTADO_CUENTA" F
    INNER JOIN "MAESTROS"."TCGESPRO_PERIODICIDAD" PG ON F."FCN_ID_PERIODICIDAD_REVERSO" = PG."FTN_ID_PERIODICIDAD"
    ...
    INNER JOIN "MAESTROS"."TTGESPRO_MOV_PROFUTURO_CONSAR" PC ON R."FCN_ID_CONCEPTO_MOVIMIENTO" = PC."FCN_ID_MOVIMIENTO_PROFUTURO"
    ...
    LEFT JOIN "MAESTROS"."TCGESPRO_REFER_MOV_CONSAR"  TRMC ON MC."FCN_ID_REFERENCIA" = TRMC."FTN_ID_REFERENCIA"
    UNION ALL
    SELECT
    F."FCN_ID_FORMATO_ESTADO_CUENTA" AS "FTN_ID_FORMATO",
    MC."FTC_MOV_TIPO_AHORRO" AS "FTC_SECCION",
